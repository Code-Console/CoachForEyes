...
class Game {
    ...
    init() {
        ...
        loder.load('assets/Stage_v01.gltf',
            function ( gltf ) {
        ...
        loder.load('assets/Sitting Clap.gltf',
            function ( gltf ) {
	            game.scene.add( gltf.scene);
    ...
    // );
        ...
        this.mp3Crect = loadSound("correct","assets/sound/correct.mp3");
        this.mp3Wrong = loadSound("wrong","assets/sound/wrong.mp3");
        this.mp3Intro = loadSound("intro","assets/sound/intro.mp3");
        this.mp3Heart = loadSound('heart',"assets/sound/heart.mp3");
        this.mp3Heart.loop = true;
        this.mp3Heart.pCnt =0;

        AssetLoader.add.image('assets/landing-bg.jpg');
        AssetLoader.add.image('assets/landing-bg.png');
        AssetLoader.add.image('assets/mf2.png');
        AssetLoader.add.image('assets/logo.png');
        AssetLoader.add.image('assets/PlayNow.png');

        AssetLoader.add.image('assets/5050.png');
        AssetLoader.add.image('assets/audiance poll.png');
        AssetLoader.add.image('assets/correct-bg.png');
        AssetLoader.add.image('assets/incorrect-bg.png');
        AssetLoader.add.image('assets/normal-png.png');
        AssetLoader.add.image('assets/points.png');
        AssetLoader.add.image('assets/question-bg.png');
        AssetLoader.add.image('assets/audiance_bg.png');
        AssetLoader.add.image('assets/power.png');
        AssetLoader.add.image('assets/playagain.png');
        AssetLoader.add.image('assets/learn.png');
        AssetLoader.add.image('assets/great-work.png');
        AssetLoader.add.image('assets/endscreen-bg.png');
        AssetLoader.add.image('assets/close.png');

        AssetLoader.progressListener = function (progress) {
            console.log("progress = "+progress);
        };
        AssetLoader.load(function () {
            game.mTex_BG = loadUI(game.gameUI, 'assets/landing-bg.jpg', 0, 0, 0);
            game.mTex_BGPlay = loadUI(game.gameUI, 'assets/landing-bg.png', 0, 0, 0);
            game.mTex_BGR = loadUIRect(game.gameUI, 0, 0, 100, 100, '#000000');
            game.mTex_logo = loadUI(game.gameUI, 'assets/logo.png', 0, 0, 0);
            game.mTex_PlayNow = loadUI(game.gameUI, 'assets/PlayNow.png', 0, 0, 10);
            game.mTex_5050 = loadUI(game.gameUI, 'assets/5050.png', 0, 0, 11);

            game.mTex_audiancePoll = loadUI(game.gameUI, 'assets/audiance poll.png', 0, 0, 12);
            game.mTex_audiancePoll.aUsed = 1;
            game.mTex_5050.aUsed = 1;
            game.mTex_normal = [];
            game.mTex_in50 = [];
            for (let i = 0; i < 4; i++) {
                game.mTex_normal.push(loadUI(game.gameUI, 'assets/normal-png.png', 0, 0, i+1));
                game.mTex_normal[i].a50 = 1;
                game.mTex_normal[i].nApha = 0.01;
            }
            for (let i = 0; i < 4; i++) {
                game.mTex_in50.push(loadUI(game.gameUI, 'assets/incorrect-bg.png', 0, 0, 0));
            }
            game.mTex_correct = loadUI(game.gameUI, 'assets/correct-bg.png', 0, 0, 0);
            game.mTex_incorrect = loadUI(game.gameUI, 'assets/incorrect-bg.png', 0, 0, 0);
            game.mTex_points = loadUI(game.gameUI, 'assets/points.png', 0, 0, 0);
            game.mTex_question = loadUI(game.gameUI, 'assets/question-bg.png', 0, 0, 0);

            game.mTex_endscreen = loadUI(game.gameUI, 'assets/endscreen-bg.png', 0, 0, 0);
            game.mTex_greatwork = loadUI(game.gameUI, 'assets/great-work.png', 0, 0, 0);
            game.mTex_playagain = loadUI(game.gameUI, 'assets/playagain.png', 0, 0, 10);
            game.mTex_learn = loadUI(game.gameUI, 'assets/learn.png', 0, 0, 13);
            ...
            game.mTex_audiance_bg = loadUI(game.gameUI, 'assets/audiance_bg.png', 0, 0, 0);
            game.mTex_power = [];
            game.mTex_pFont = [];
            for (let i = 0; i < 4; i++) {
                game.mTex_power.push(loadUI(game.gameUI, 'assets/power.png', 0, 0, 0));
            ...
            game.mTex_close = loadUI(game.gameUI, 'assets/close.png', 0, 0, 14);
            game.mTex_Sahi = loadUI(game.gameUI, 'assets/mf2.png', 0, 0, 0);
    ...
    //    console.log(this.AnsClicked+" = clickval = "+clickval);
       ...
       if(clickval == 11 && this.mTex_5050.aUsed == 1 && this.mTex_audiance_bg.visible == false){
        ...
        if(clickval == 12 && this.mTex_audiancePoll.aUsed == 1){
    ...
    drawOver(){
        DrawTexture(this.mTex_BG, 0, 0, 1080, 1920);
        DrawTexture(this.mTex_BGR, 0, -100, 1080, MAXH,.5);
    ...
    drawPlay(){
        ...
        this.camera.lookAt(new THREE.Vector3(0, 0, 0));
        DrawTexture(this.mTex_BGPlay, 0, 910, 1080, 99);
        DrawTexture(this.mTex_Sahi, 0, -840, 634*1.4, 57*1.4,this.mTex_Sahi.a);
        ...
        if(this.dis < 11){
            if(this.mTex_Sahi.a<1){
                ...
                if(this.mTex_PlayNow.a<50)
                    DrawTexture(this.mTex_BGR, 0, -100, 1200, MAXH,this.mTex_PlayNow.a*.015);
